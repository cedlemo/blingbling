...
local function get_day_of_month_in_kanji(n)
	...
	elseif n<20 then
		return kanji_numbers[10]..(kanji_numbers[n-10] or "")
	elseif n<30 then
		return kanji_numbers[2]..kanji_numbers[10]..(kanji_numbers[n-20] or "")
	elseif n<=31 then
		return kanji_numbers[3]..kanji_numbers[10]..(kanji_numbers[n-30] or "")
	end
end
